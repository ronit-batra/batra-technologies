...
export default function ScrollToTop() {
  ...
  return (
    <button
      ...
      className="fixed bottom-8 right-8 z-50 w-12 h-12 bg-gradient-to-br from-gold-500 to-gold-700 hover:from-gold-400 hover:to-gold-600 text-dark-950 rounded-full shadow-lg shadow-gold-500/20 flex items-center justify-center transition-all duration-300 hover:scale-110 hover:shadow-gold-500/30 active:scale-95"
